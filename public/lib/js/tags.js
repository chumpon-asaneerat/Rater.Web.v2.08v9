...
riot.tag2('nav-bar', '<p>logo</p> <yield></yield>', 'nav-bar,[data-is="nav-bar"]{ background: cornflowerblue; color: whitesmoke; } nav-bar p,[data-is="nav-bar"] p{ display: inline; padding: 2px; }', '', function(opts) {
