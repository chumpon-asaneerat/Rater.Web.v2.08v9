riot.tag2('app', '<nav-bar class="navibar"></nav-bar> <div class="scrarea"> <yield></yield> </div> <page-footer class="footer"></page-footer>', 'app,[data-is="app"]{ margin: 0 auto; height: 100vh; width: 100vh; display: grid; grid-template-columns: 1fr; grid-template-rows: 40px 1fr 20px; grid-template-areas: \'navbar\' \'scrarea\' \'footer\'; overflow: hidden; } app .navbar,[data-is="app"] .navbar{ grid-area: navibar; } app .scrarea,[data-is="app"] .scrarea{ grid-area: scrarea; overflow: auto; } app .footer,[data-is="app"] .footer{ grid-area: footer; padding: 0 2px; }', '', function(opts) {
