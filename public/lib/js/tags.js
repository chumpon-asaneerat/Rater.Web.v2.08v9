...
riot.tag2('dual-screen', '<div class="auto-container"> <div ref="flipper" class="flipper"> <div class="viewer-block"> <div class="content"> <yield from="viewer"></yield> </div> </div> <div class="entry-block"> <div class="content"> <yield from="entry"></yield> </div> </div> </div> </div>', 'dual-screen,[data-is="dual-screen"]{ margin: 0; padding: 0; width: 100%; height: 100%; display: grid; grid-template-columns: 1fr; grid-template-rows: 1fr; grid-template-areas: \'auto-container\'; overflow: hidden; } dual-screen .auto-container,[data-is="dual-screen"] .auto-container{ margin: 0; padding: 0; width: 100%; height: 100%; grid-area: auto-container; border: 1px solid #f1f1f1; } dual-screen .flipper,[data-is="dual-screen"] .flipper{ margin: 0; padding: 0; position: relative; } dual-screen .auto-container .flipper.toggle,[data-is="dual-screen"] .auto-container .flipper.toggle{ cursor: default; } dual-screen .viewer-block,[data-is="dual-screen"] .viewer-block,dual-screen .entry-block,[data-is="dual-screen"] .entry-block{ display: block; margin: 0; padding: 0; width: 100%; height: 100%; max-width: 100vw; max-height: calc(100vh - 63px); overflow: auto; backface-visibility: hidden; } dual-screen .entry-block,[data-is="dual-screen"] .entry-block{ background-color: dimgray; color: white; } dual-screen .content,[data-is="dual-screen"] .content{ position: relative; display: block; } @media only screen and (max-width: 600px) { dual-screen .flipper,[data-is="dual-screen"] .flipper{ width: 100%; height: 100%; transition: transform 0.5s; transform-style: preserve-3d; } dual-screen .auto-container .flipper.toggle,[data-is="dual-screen"] .auto-container .flipper.toggle{ transform: rotateY(180deg); } dual-screen .viewer-block,[data-is="dual-screen"] .viewer-block,dual-screen .entry-block,[data-is="dual-screen"] .entry-block{ position: absolute; } dual-screen .viewer-block,[data-is="dual-screen"] .viewer-block{ transform: rotateY(0deg); } dual-screen .entry-block,[data-is="dual-screen"] .entry-block{ transform: rotateY(180deg); } } @media only screen and (min-width: 600px) and (max-width: 1600px) { dual-screen .flipper,[data-is="dual-screen"] .flipper{ display: grid; grid-template-columns: 1fr auto; grid-template-rows: 1fr; grid-template-areas: \'viewer entry\'; } dual-screen .viewer-block,[data-is="dual-screen"] .viewer-block,dual-screen .entry-block,[data-is="dual-screen"] .entry-block{ position: relative; } dual-screen .viewer-block,[data-is="dual-screen"] .viewer-block{ grid-area: viewer; } dual-screen .entry-block,[data-is="dual-screen"] .entry-block{ grid-area: entry; } }', '', function(opts) {
        let self = this;
        let flipper;
