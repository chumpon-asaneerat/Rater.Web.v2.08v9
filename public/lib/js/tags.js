...
riot.tag2('email-input', '<input type="text" name="" required=""> <label>{opts.title}</label>', 'email-input input:-webkit-autofill,[data-is="email-input"] input:-webkit-autofill,email-input input:-webkit-autofill:hover,[data-is="email-input"] input:-webkit-autofill:hover,email-input input:-webkit-autofill:focus,[data-is="email-input"] input:-webkit-autofill:focus{ font-family: sans-serif; font-size: 14px; transition: background-color 5000s ease-in-out 0s; } email-input,[data-is="email-input"]{ margin: 0; padding: 0; font-family: sans-serif; font-size: 14px; display: inline-block; position: relative; height: auto; width: 400px; background: #fff; padding: 10px; box-shadow: 0 5px 10px solid rgba(0, 0, 0, .2); } email-input input,[data-is="email-input"] input{ padding: 5px 0; margin-bottom: 5px; width: 100%; background-color: #fff; box-sizing: border-box; box-shadow: none; outline: none; border: none; border-bottom: 2px solid #999; } email-input label,[data-is="email-input"] label{ position: absolute; top: 15px; left: 15px; color: #999; transition: .5s; pointer-events: none; } email-input input:focus ~ label,[data-is="email-input"] input:focus ~ label,email-input input:-webkit-autofill ~ label,[data-is="email-input"] input:-webkit-autofill ~ label,email-input input:valid ~ label,[data-is="email-input"] input:valid ~ label{ top: -5px; left: 10px; color: #f7497d; font-weight: bold; } email-input input:focus,[data-is="email-input"] input:focus,email-input input:valid,[data-is="email-input"] input:valid{ border-bottom: 2px solid #f7497d; }', '', function(opts) {
});

riot.tag2('password-input', '<input type="password" name="" required=""> <label>{opts.title}</label>', 'password-input input:-webkit-autofill,[data-is="password-input"] input:-webkit-autofill,password-input input:-webkit-autofill:hover,[data-is="password-input"] input:-webkit-autofill:hover,password-input input:-webkit-autofill:focus,[data-is="password-input"] input:-webkit-autofill:focus{ font-family: sans-serif; font-size: 14px; transition: background-color 5000s ease-in-out 0s; } password-input,[data-is="password-input"]{ margin: 0; padding: 0; font-family: sans-serif; font-size: 14px; display: inline-block; position: relative; height: auto; width: 400px; background: #fff; padding: 10px; box-shadow: 0 5px 10px solid rgba(0, 0, 0, .2); } password-input input,[data-is="password-input"] input{ padding: 5px 0; margin-bottom: 5px; width: 100%; background-color: #fff; box-sizing: border-box; box-shadow: none; outline: none; border: none; border-bottom: 2px solid #999; } password-input label,[data-is="password-input"] label{ position: absolute; top: 15px; left: 15px; color: #999; transition: .5s; pointer-events: none; } password-input input:focus ~ label,[data-is="password-input"] input:focus ~ label,password-input input:-webkit-autofill ~ label,[data-is="password-input"] input:-webkit-autofill ~ label,password-input input:valid ~ label,[data-is="password-input"] input:valid ~ label{ top: -5px; left: 10px; color: #f7497d; font-weight: bold; } password-input input:focus,[data-is="password-input"] input:focus,password-input input:valid,[data-is="password-input"] input:valid{ border-bottom: 2px solid #f7497d; }', '', function(opts) {
});

riot.tag2('text-input', '<input type="text" name="" required=""> <label>{opts.title}</label>', 'text-input input:-webkit-autofill,[data-is="text-input"] input:-webkit-autofill,text-input input:-webkit-autofill:hover,[data-is="text-input"] input:-webkit-autofill:hover,text-input input:-webkit-autofill:focus,[data-is="text-input"] input:-webkit-autofill:focus{ font-family: sans-serif; font-size: 14px; transition: background-color 5000s ease-in-out 0s; } text-input,[data-is="text-input"]{ margin: 0; padding: 0; font-family: sans-serif; font-size: 14px; display: inline-block; position: relative; height: auto; width: 400px; background: #fff; padding: 10px; box-shadow: 0 5px 10px solid rgba(0, 0, 0, .2); } text-input input,[data-is="text-input"] input{ padding: 5px 0; margin-bottom: 5px; width: 100%; background-color: #fff; box-sizing: border-box; box-shadow: none; outline: none; border: none; border-bottom: 2px solid #999; } text-input label,[data-is="text-input"] label{ position: absolute; top: 15px; left: 15px; color: #999; transition: .5s; pointer-events: none; } text-input input:focus ~ label,[data-is="text-input"] input:focus ~ label,text-input input:-webkit-autofill ~ label,[data-is="text-input"] input:-webkit-autofill ~ label,text-input input:valid ~ label,[data-is="text-input"] input:valid ~ label{ top: -5px; left: 10px; color: #f7497d; font-weight: bold; } text-input input:focus,[data-is="text-input"] input:focus,text-input input:valid,[data-is="text-input"] input:valid{ border-bottom: 2px solid #f7497d; }', '', function(opts) {
});
